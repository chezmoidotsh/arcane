...
| 10.0.0.22 | o11y LXC                        | data.o11y.chezmoi.sh                                       | Victoria stack — central metrics/logs/traces. `o11y.chezmoi.sh` moved to Grafana on rhodes.akn (#1159). Dual-NIC: also `10.128.0.5` on talosnet (`eth1`)                                                       |
