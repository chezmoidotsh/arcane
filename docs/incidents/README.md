...
| 2026-05-30 | High     | [redis-imagepullbackoff-zot-corrupted-index](2026-05-30-redis-imagepullbackoff-zot-corrupted-index.md)       | `invalid character '\xc9' looking for beginning of value`, `unsupported repository layout version`, `rate limit exceeded [http 429]`, `ImagePullBackOff` | Zot corrupted redis index.json + Docker Hub rate limiting → redis pods in ImagePullBackOff for \~8h |
