...
def generate_random_glitch_timings(duration_sec: float) -> Tuple[float, float, float, float, float, float]:
    """
    ...
    Returns:
        A tuple containing timing percentages.
    """
    min_separation = 7.5 / duration_sec * 100
    glitch_duration = 0.25 / duration_sec * 100
    glitch_both_top_duration = 0.3 / duration_sec * 100
    glitch_both_bottom_duration = 0.1 / duration_sec * 100
    glitch_both_bottom_delay = 0.15 / duration_sec * 100
    ...
    return (
        ...
        glitch2_start,
        glitch_duration,
        glitch_both_top_duration,
        glitch_both_bottom_duration,
        glitch_both_bottom_delay
    )
...
def get_keyframes_for_glitch(group_index: int, glitch_offset: int, duration_sec: float) -> str:
    ...
    (
        glitch1_start,
        glitch2_start,
        glitch_duration_percent,
        glitch_both_top_duration,
        glitch_both_bottom_duration,
        glitch_both_bottom_delay
    ) = generate_random_glitch_timings(duration_sec)
...
def generate_icon_svg(
    ...
    if not os.path.exists(font_path):
        ...
        print(f"Please provide a valid path with --font or ensure the font exists at {font_path}", file=sys.stderr)
        sys.exit(1)
