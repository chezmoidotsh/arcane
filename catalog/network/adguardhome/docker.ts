...
import { AdGuardHomeImage, ImageArgs as ImageOpts } from "./image";
import { Version } from "./version";

export { AdGuardHomeImage };
export { Version };
 ...
 */
export interface AdGuardHomeOpts {
    /**
...
export class AdGuardHome extends pulumi.ComponentResource {
    ...
    constructor(name: string, args: AdGuardHomeOpts, opts?: pulumi.ComponentResourceOptions) {
        ...
        const image = new AdGuardHomeImage(name, args.imageOpts, { parent: this });
        ...
        this.container = new docker.Container(
            name,
            {
                ...
                tmpfs: {
                    "/tmp/adguardhome": "exec,uid=64138,gid=64138",
                },
                user: "adguardhome",
