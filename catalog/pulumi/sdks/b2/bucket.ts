...
export class Bucket extends pulumi.CustomResource {
	 ...
	 */
	public /*out*/ declare readonly accountId: pulumi.Output<string>;
	public declare readonly b2BucketId: pulumi.Output<string>;
	/**
	 * The ID of the bucket.
	 */
	public /*out*/ declare readonly bucketId: pulumi.Output<string>;
	/**
	 * User-defined information to be stored with the bucket.
	 */
	public declare readonly bucketInfo: pulumi.Output<
		{ [key: string]: string } | undefined
	>;
	/**
	 * The name of the bucket. **Modifying this attribute will force creation of a new resource.**
	 */
	public declare readonly bucketName: pulumi.Output<string>;
	/**
	 * The bucket type. Either 'allPublic', meaning that files in this bucket can be downloaded by anybody, or 'allPrivate'.
	 */
	public declare readonly bucketType: pulumi.Output<string>;
	/**
	 * The initial list of CORS rules for this bucket.
	 */
	public declare readonly corsRules: pulumi.Output<
		outputs.BucketCorsRule[] | undefined
	>;
	/**
	 * The default server-side encryption settings for this bucket.
	 */
	public declare readonly defaultServerSideEncryption: pulumi.Output<
		outputs.BucketDefaultServerSideEncryption | undefined
	>;
	/**
	 * File lock enabled flag, and default retention settings.
	 */
	public declare readonly fileLockConfigurations: pulumi.Output<
		outputs.BucketFileLockConfiguration[] | undefined
	>;
	/**
	 * The initial list of lifecycle rules for this bucket.
	 */
	public declare readonly lifecycleRules: pulumi.Output<
		outputs.BucketLifecycleRule[] | undefined
	>;
	/**
	 * List of bucket options.
	 */
	public /*out*/ declare readonly options: pulumi.Output<string[]>;
	/**
	 * Bucket revision.
	 */
	public /*out*/ declare readonly revision: pulumi.Output<number>;
	...
	constructor(
		name: string,
		argsOrState?: BucketArgs | BucketState,
		opts?: pulumi.CustomResourceOptions,
	) {
		...
		if (opts.id) {
			...
			resourceInputs["defaultServerSideEncryption"] =
				state?.defaultServerSideEncryption;
...
export interface BucketState {
	 ...
	 * The default server-side encryption settings for this bucket.
	 */
	defaultServerSideEncryption?: pulumi.Input<
		inputs.BucketDefaultServerSideEncryption | undefined
	>;
	/**
	 * File lock enabled flag, and default retention settings.
	 */
	fileLockConfigurations?: pulumi.Input<
		pulumi.Input<inputs.BucketFileLockConfiguration>[] | undefined
	>;
	/**
	 * The initial list of lifecycle rules for this bucket.
	 */
	lifecycleRules?: pulumi.Input<
		pulumi.Input<inputs.BucketLifecycleRule>[] | undefined
	>;
	/**
	 * List of bucket options.
	 */
