...
export class BucketNotificationRules extends pulumi.CustomResource {
	...
	public static get(
		...
		state?: BucketNotificationRulesState,
	...
	public declare readonly bucketNotificationRulesId: pulumi.Output<string>;
	/**
	 * An array of Event Notification Rules.
	 */
	public declare readonly notificationRules: pulumi.Output<
		outputs.BucketNotificationRulesNotificationRule[]
	>;
	...
	constructor(
		name: string,
		argsOrState?: BucketNotificationRulesArgs | BucketNotificationRulesState,
		opts?: pulumi.CustomResourceOptions,
	) {
		...
		if (opts.id) {
			...
			resourceInputs["bucketNotificationRulesId"] =
				state?.bucketNotificationRulesId;
...
export interface BucketNotificationRulesState {
	 ...
	 * An array of Event Notification Rules.
	 */
	notificationRules?: pulumi.Input<
		pulumi.Input<inputs.BucketNotificationRulesNotificationRule>[] | undefined
	>;
}
...
export interface BucketNotificationRulesArgs {
	 ...
	 */
	notificationRules: pulumi.Input<
		pulumi.Input<inputs.BucketNotificationRulesNotificationRule>[]
	>;
}
