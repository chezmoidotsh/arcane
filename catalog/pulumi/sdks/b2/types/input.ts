...
export interface BucketFileLockConfiguration {
	...
	defaultRetention?: pulumi.Input<
		inputs.BucketFileLockConfigurationDefaultRetention | undefined
	>;
	/**
...
export interface BucketFileLockConfigurationDefaultRetention {
	 ...
	 */
	period?: pulumi.Input<
		inputs.BucketFileLockConfigurationDefaultRetentionPeriod | undefined
	>;
}
...
export interface BucketFileVersionServerSideEncryption {
	 ...
	 */
	key?: pulumi.Input<
		inputs.BucketFileVersionServerSideEncryptionKey | undefined
	>;
	/**
	 * Server-side encryption mode.
	 */
...
export interface BucketLifecycleRule {
	 ...
	 */
	daysFromStartingToCancelingUnfinishedLargeFiles?: pulumi.Input<
		number | undefined
	>;
	/**
...
export interface BucketNotificationRulesNotificationRuleTargetConfiguration {
	...
	customHeaders?: pulumi.Input<
		| pulumi.Input<inputs.BucketNotificationRulesNotificationRuleTargetConfigurationCustomHeader>[]
		| undefined
	>;
	/**
