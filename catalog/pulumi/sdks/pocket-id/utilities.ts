...
export async function getPackage(): Promise<string | undefined> {
	return runtime.registerPackage({
		baseProviderName: "openapi-provider",
		baseProviderVersion: "0.8.3",
		baseProviderDownloadUrl: "",
		packageName: "pocket-id-api",
		packageVersion: "1.0.0",
		base64Parameter: "eyJzcGVjIjoiaHR0cHM6Ly9wb2NrZXQtaWQub3JnL3N3YWdnZXIueWFtbCJ9",
	});
}
