...
export class S3Endpoint extends pulumi.CustomResource {
	 ...
	 */
	public declare readonly accessKey: pulumi.Output<string>;
	/**
	 * Endpoint to access S3 object store.
	 */
	public declare readonly endpoint: pulumi.Output<string>;
	/**
	 ...
	 */
	public declare readonly pathStyle: pulumi.Output<boolean | undefined>;
	/**
	 ...
	 */
	public declare readonly providerQuirks: pulumi.Output<string[] | undefined>;
	/**
	 * Region to access S3 object store (3-32 chars, lowercase alphanumeric with dashes/underscores).
	 */
	public declare readonly region: pulumi.Output<string | undefined>;
	/**
	 * ID to uniquely identify S3 client config (3-32 chars, alphanumeric with dots, dashes, underscores).
	 */
	public declare readonly s3EndpointId: pulumi.Output<string>;
	/**
	 * S3 secret key.
	 */
	public declare readonly secretKey: pulumi.Output<string>;
	...
	constructor(
		name: string,
		argsOrState?: S3EndpointArgs | S3EndpointState,
		opts?: pulumi.CustomResourceOptions,
	) {
