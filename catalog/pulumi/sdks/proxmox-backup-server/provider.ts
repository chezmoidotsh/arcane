...
export class Provider extends pulumi.ProviderResource {
	 ...
	 */
	public declare readonly apiToken: pulumi.Output<string | undefined>;
	/**
	...
	constructor(
		...
		opts = opts || {};
		{
			resourceInputs["apiToken"] = args?.apiToken
				? pulumi.secret(args.apiToken)
				: undefined;
			resourceInputs["endpoint"] = args?.endpoint;
			resourceInputs["insecure"] = pulumi
				.output(args?.insecure)
				.apply(JSON.stringify);
			resourceInputs["password"] = args?.password
				? pulumi.secret(args.password)
				: undefined;
			resourceInputs["timeout"] = pulumi
				.output(args?.timeout)
				.apply(JSON.stringify);
	...
	terraformConfig(): pulumi.Output<{ [key: string]: any }> {
		const result: pulumi.Output<Provider.TerraformConfigResult> =
			pulumi.runtime.call(
				"pulumi:providers:pbs/terraformConfig",
				{
					__self__: this,
				},
				this,
