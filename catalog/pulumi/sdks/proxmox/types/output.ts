...
export interface GetAcmeAccountAccount {
    ...
    createdAt: string;
    /**
     * The status of the account. Can be one of <span pulumi-lang-nodejs="`valid`" pulumi-lang-dotnet="`Valid`" pulumi-lang-go="`valid`" pulumi-lang-python="`valid`" pulumi-lang-yaml="`valid`" pulumi-lang-java="`valid`" pulumi-lang-hcl="`valid`">`valid`</span>, <span pulumi-lang-nodejs="`deactivated`" pulumi-lang-dotnet="`Deactivated`" pulumi-lang-go="`deactivated`" pulumi-lang-python="`deactivated`" pulumi-lang-yaml="`deactivated`" pulumi-lang-java="`deactivated`" pulumi-lang-hcl="`deactivated`">`deactivated`</span> or <span pulumi-lang-nodejs="`revoked`" pulumi-lang-dotnet="`Revoked`" pulumi-lang-go="`revoked`" pulumi-lang-python="`revoked`" pulumi-lang-yaml="`revoked`" pulumi-lang-java="`revoked`" pulumi-lang-hcl="`revoked`">`revoked`</span>.
     */
    status: string;
}
...
export interface GetHardwarePciDevice {
    /**
     * The PCI class code (hex, e.g. <span pulumi-lang-nodejs="`0x030000`" pulumi-lang-dotnet="`0x030000`" pulumi-lang-go="`0x030000`" pulumi-lang-python="`0x030000`" pulumi-lang-yaml="`0x030000`" pulumi-lang-java="`0x030000`" pulumi-lang-hcl="`0x030000`">`0x030000`</span>).
     */
    class: string;
    /**
     * The PCI device ID (hex, e.g. <span pulumi-lang-nodejs="`0x5916`" pulumi-lang-dotnet="`0x5916`" pulumi-lang-go="`0x5916`" pulumi-lang-python="`0x5916`" pulumi-lang-yaml="`0x5916`" pulumi-lang-java="`0x5916`" pulumi-lang-hcl="`0x5916`">`0x5916`</span>).
     */
    device: string;
    /**
    ...
    /**
     * The PCI vendor ID (hex, e.g. <span pulumi-lang-nodejs="`0x8086`" pulumi-lang-dotnet="`0x8086`" pulumi-lang-go="`0x8086`" pulumi-lang-python="`0x8086`" pulumi-lang-yaml="`0x8086`" pulumi-lang-java="`0x8086`" pulumi-lang-hcl="`0x8086`">`0x8086`</span>).
     */
    vendor: string;
    /**
