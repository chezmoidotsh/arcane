...
CREATE TYPE nuq.group_status AS ENUM ('active', 'completed', 'paused');
...
-- For getCrawlJobs: query using group_id, status (completed or failed), and data->>'mode'
