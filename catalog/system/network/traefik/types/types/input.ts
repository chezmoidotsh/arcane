...
export namespace traefik {
    export namespace v1alpha1 {
        ...
        export interface IngressRouteSpecRoutesServicesArgs {
             ...
             */
            healthCheck?: pulumi.Input<inputs.traefik.v1alpha1.IngressRouteSpecRoutesServicesHealthCheckArgs>;
            /**
         ...
         * Healthcheck defines health checks for ExternalName services.
         */
        export interface IngressRouteSpecRoutesServicesHealthCheckArgs {
            /**
        ...
        export interface MiddlewareSpecErrorsServiceArgs {
             ...
             * Healthcheck defines health checks for ExternalName services.
             */
            healthCheck?: pulumi.Input<inputs.traefik.v1alpha1.MiddlewareSpecErrorsServiceHealthCheckArgs>;
            /**
             * Kind defines the kind of the Service.
             */
            kind?: pulumi.Input<string>;
         ...
         * Healthcheck defines health checks for ExternalName services.
         */
        export interface MiddlewareSpecErrorsServiceHealthCheckArgs {
            /**
             * FollowRedirects defines whether redirects should be followed during the health check calls.
             * Default: true
             */
        ...
        export interface TraefikServiceSpecMirroringArgs {
             ...
             * Healthcheck defines health checks for ExternalName services.
             */
            healthCheck?: pulumi.Input<inputs.traefik.v1alpha1.TraefikServiceSpecMirroringHealthCheckArgs>;
            /**
             * Kind defines the kind of the Service.
             */
            kind?: pulumi.Input<string>;
         ...
         * Healthcheck defines health checks for ExternalName services.
         */
        export interface TraefikServiceSpecMirroringHealthCheckArgs {
            /**
             * FollowRedirects defines whether redirects should be followed during the health check calls.
             * Default: true
             */
        ...
        export interface TraefikServiceSpecMirroringMirrorsArgs {
             ...
             * Healthcheck defines health checks for ExternalName services.
             */
            healthCheck?: pulumi.Input<inputs.traefik.v1alpha1.TraefikServiceSpecMirroringMirrorsHealthCheckArgs>;
            /**
             * Kind defines the kind of the Service.
             */
            kind?: pulumi.Input<string>;
         ...
         * Healthcheck defines health checks for ExternalName services.
         */
        export interface TraefikServiceSpecMirroringMirrorsHealthCheckArgs {
            /**
             * FollowRedirects defines whether redirects should be followed during the health check calls.
             * Default: true
             */
        ...
        export interface TraefikServiceSpecWeightedServicesArgs {
             ...
             * Healthcheck defines health checks for ExternalName services.
             */
            healthCheck?: pulumi.Input<inputs.traefik.v1alpha1.TraefikServiceSpecWeightedServicesHealthCheckArgs>;
            /**
             * Kind defines the kind of the Service.
             */
            kind?: pulumi.Input<string>;
         ...
         * Healthcheck defines health checks for ExternalName services.
         */
        export interface TraefikServiceSpecWeightedServicesHealthCheckArgs {
            /**
             * FollowRedirects defines whether redirects should be followed during the health check calls.
             * Default: true
             */
