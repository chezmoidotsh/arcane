...
Operational truths distilled from past incidents and intentionally exposed for future agents (human or AI) before they
touch the corresponding components.
...
Bullets are extracted from the `## Agent Knowledge` section of post-mortems in `docs/incidents/*.md`. The post-mortem is
authoritative; this directory is a cross-cutting view. When updating, prefer editing the source PM and re-extracting.
