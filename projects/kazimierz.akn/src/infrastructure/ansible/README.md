...
> See [ADR-009](../../../../docs/decisions/009-kazimierz-ansible-over-kubernetes.md) for the full rationale. Summary: Pangolin is Docker Compose-first, Gerbil requires host networking, and Kubernetes adds 1GB overhead for minimal benefit on this single-app VPS.
...
vim projects/kazimierz.akn/src/apps/pangolin/docker-compose.yml
