...
| **Infinity**       | Local embedding & reranking server (BAAI/bge-m3, BAAI/bge-reranker-v2-m3) on MPS.                       | **nix-darwin** — managed as a user-level launchd agent in `modules/infinity.nix`.                                                                                                                                                                                                                                                                                                                                                  |
...
| Infinity Embeddings    | `http://infinity.llm.chezmoi.sh:1234` | `127.0.0.1:7997` |
