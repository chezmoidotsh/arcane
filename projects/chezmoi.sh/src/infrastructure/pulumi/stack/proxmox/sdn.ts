...
export const pvenetZone = new proxmox.SdnZoneSimple("pve-sdn-zone-pvenet", {
	sdnZoneSimpleId: "pvenet",
	ipam: "pve",
	dhcp: "dnsmasq",
});

export const talosnetVnet = new proxmox.SdnVnet("pve-sdn-vnet-talosnet", {
	sdnVnetId: "talosnet",
...
// `snat 1`" callout.
export const talosnetSubnet = new proxmox.SdnSubnet("pve-sdn-subnet-talosnet", {
