...
| `toolbox/proxmox-backup-server-docs/` | Standalone doc generator — rebuilds `docs/PROXMOX_BACKUP_SERVER.md` from deployed stack state; see [`toolbox/proxmox-backup-server-docs/README.md`](toolbox/proxmox-backup-server-docs/README.md) |
...
| `proxmox-backup-server:docs:generate` | Rebuild `docs/PROXMOX_BACKUP_SERVER.md` from the last-applied stack state (standalone; no Pulumi run)                                |
...
- [`toolbox/proxmox-backup-server-docs/README.md`](toolbox/proxmox-backup-server-docs/README.md) — how the PBS doc
  generator works
