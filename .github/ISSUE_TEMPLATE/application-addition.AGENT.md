...
name: ":heavy\_plus\_sign: Application Addition (AI Agent)"
about: Request to add a new application to the infrastructure (AI agent version)
title: ":heavy\_plus\_sign:(project:<cluster>): Add <application-name>"
...
# :heavy\_plus\_sign:(project:<cluster>): Add <application-name>
